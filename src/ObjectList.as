...
package
{
	...
	[SWF(width="1024",height="768",frameRate="12",backgroundColor=0x000000)] public class DataList extends Sprite
	{
		...
		private function make_lines(obj:Object):BaseSprite
		{
		...
		private function make_txt(s:String,_width:int=180):TextField
		{
		...
		private function make_txt_line(_pname:String,_pvalue:String):BaseSprite
		{
			var mc:BaseSprite = new BaseSprite();
			mc.addChild(make_txt(_pname));
			var pvalue:TextField = make_txt(_pvalue);
			pvalue.x = mc.width+10;
			mc.addChild(pvalue);
			return mc;
		}

		private function make_photo_lines(objs:Array,xs:Array):BaseSprite
		{
		}
